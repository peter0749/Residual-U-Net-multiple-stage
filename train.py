...
def build_stage(inputs, last=None):
    ...
    def up():
        return UpSampling2D()
    def avepool(act='sigmoid'):
        return Conv2D(1, (1, 1), activation=act)
    ...
    outputs = avepool('sigmoid') (c11)
    return outputs, o1

inputs = Input((IMG_DIM, IMG_DIM, 3))
out1, t1 = build_stage(inputs, None)
out2, t2 = build_stage(out1, t1)
out3, _ = build_stage(out2, t2)
